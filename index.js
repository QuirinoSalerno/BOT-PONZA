...
app.post('/webhook', async function(req, res) {
    var mittente = req.body.From;
    var testo = req.body.Body;
    ...
    try {
        ...
        res.send('<Response><Message>' + testo_risposta + '</Message></Response>');

    } catch (err) {
        console.error('Errore:', err);
        res.set('Content-Type', 'text/xml');
        res.send('<Response><Message>Ciao! Ho un problema tecnico. Quirino ti risponde a breve!</Message></Response>');
    }
});
